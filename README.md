...
<p>Я фулстек-разработчик с инженерным бэкграундом. Специализируюсь на создании сложных продуктов с нуля — от идеи до релиза, от бэка до нативных модулей.
Углубленно изучаю промт-инжиниринг, чтобы выжимать максимум из ИИ инструментов, но код всегда проверяю сам. Вижу, где ИИ ошибается в логике и переусложняет.
Работал с Asterisk, нативной разработкой под Android/iOS.Участвовал в разработке курса React-разработчик от Яндекс.Практикума.</p>

## >>> МОЙ СТЕК

<!-- Сервис исходников с иконками -->
