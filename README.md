...
Я фулстек-разработчик с инженерным бэкграундом. Специализируюсь на создании сложных продуктов с нуля — от идеи до релиза, от бэка до нативных модулей.
...
Работал с Asterisk, нативной разработкой под Android/iOS.Участвовал в разработке курса React-разработчик от Яндекс.Практикума.
