...
<p>Я фулстек-разработчик с инженерным бэкграундом. Специализируюсь на разработке высоконагруженных веб-приложений. Пишу на Python и TypeScript, использую фреймворк Django для backend-разработки и библиотеку React для фронтенда.</p>
